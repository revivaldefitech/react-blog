  ...
  render() {
    ...
    return (
      <div className="footer">
        <TrackerModalComponent showModal={this.state.modal} hideModal={() => this.hideTrackerModal()}></TrackerModalComponent>
        <InfoModalComponent showModal={this.state.info} hideModal={() => this.hideModal()} title={this.state.title} body={this.state.body}></InfoModalComponent>
        <div className="upper-section">
          <div className="links-container">
            ...
            <a style={{cursor: 'pointer'}} onClick={() => this.setState({modal: true})}>
              <p>Tracker</p>
            </a>
          ...
          <div className="links-container">
            ...
            <a style={{cursor: 'pointer'}} onClick={() => this.setState({info: true, body: termsOfUse, title: 'Terms of use'})}>
              <p>Terms of Use</p>
            </a>
            <a style={{cursor: 'pointer'}} onClick={() => this.setState({info: true, body: privacyPolicy, title: 'Privacy Policy'})}>
              <p>Privacy Policy</p>
            </a>
